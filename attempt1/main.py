...
class Snyder(Scene):
    def construct(self):
        ...
        while shift_count < MATRIX_ROW_COL_CT:
            ...
            self.wait(2)
            """
            intial_move_animations, final_move_animations, intial_fade_in_animations, final_fade_in_animations, intial_fade_out_animations, final_fade_out_animations = scene3.computeTempCValues(matrixC_scene2)
            total_fade_out_animations.extend(final_fade_out_animations)
